 ...
 * @author zjf
 * @version 1.0
 * @Date 2014-5-21 下午1:55:31
 */
public class NoFinaSubjectTransAction implements Serializable,TransAction
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 873653185249040249L;
	
	
	private static final Logger logger = Logger.getLogger(NoFinaSubjectTransAction.class);
...
//		commRetInfo.setRetMsg(ConstantUtil.RetInfo.OPERATION_COMPLETED.getDesc());
		...
		try
		{
			TransHandleStrategy transHandleStrategy =handleStrategyProvider.noFinaTransStrategy();
